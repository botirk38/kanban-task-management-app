...
board_columns = [
    ...
    path('boards/<int:board_id>/columns/<int:column_id>/tasks/', TaskViewSet.as_view({'get': 'list', 'post': 'create'}), name='column-tasks'),
    path('boards/<int:board_id>/columns/<int:column_id>/tasks/<int:pk>/', TaskViewSet.as_view({'patch': 'partial_update', 'put': 'update', 'delete' : 'destroy', 'get': 'retrieve'}), name='task-detail'),
    path('boards/<int:board_id>/columns/<int:column_id>/tasks/<int:task_id>/subtasks/', SubtaskViewSet.as_view({'get': 'list', 'post': 'create' , 'put': 'update'}), name='subtask-list'),
