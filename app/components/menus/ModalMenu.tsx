...
const ModalMenu: React.FC<ModalMenuProps> = (props) => {
    ...
    return (
        <section className={` absolute bg-white flex z-50 flex-col p-4 items-start justify-center  gap-4 rounded-lg ${ props.actionType === "Task" ? "top-72 right-10 lg:right-96 lg:top-96" : "top-20 right-10"}`} onClick={e => e.stopPropagation()}>
